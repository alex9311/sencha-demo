...
Ext.define('Ext.Component', {
     ...
     * stocksnstrates how to enable the resize event for a
     ...
     *
     * The following example stocksnstrates using a dynamic string for the text of a button at the time of
