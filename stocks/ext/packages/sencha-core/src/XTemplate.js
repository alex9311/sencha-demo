 ...
 * stocksnstrate all of the supported features.
 *
 * # Sample Data
 *
 ...
 * example stocksnstrates looping over the main data object's properties:
 * 
 *     var tpl = new Ext.XTemplate(
 *         '<dl>',
 *             '<tpl foreach=".">',
 ...
 * being examined.
 *
 * This example stocksnstrates basic row striping using an inline code block and the xindex variable:
 *
 *     var tpl = new Ext.XTemplate(
 *         '<p>Name: {name}</p>',
